  ...
  "tools_to_call": [
    {
      ...
      "tool": "retrieve_documents",
      "args_template": {
        "search_terms": "standards d'adresse pour rue, code postal, ville, pays et coordonnées géographiques ; address standards for street, postal code, city, country and geographic coordinates",
        "limit": 8,
...
- Example:
  - address search → "recherche de standards d'adresse pour rue, code postal, ville et pays ; search for address standards covering street, postal code, city and country"
  - person search → "recherche de standards pour modéliser une personne (nom, prénom, naissance) ; search for standards to model a person (name, given name, birth)"
    ...
    "tools_to_call": [
      {
        ...
        "tool": "retrieve_documents",
        "args_template": {
          "search_terms": "recherche de standards d'adresse (rue, code postal, ville, pays, coordonnées géographiques) ; search for address/location standards (street, postal code, city, country, geographic coordinates)",
          "limit": 8,
          "return_full_document": true
        },
    ...
    "tools_to_call": [
      {
        ...
        "tool": "retrieve_documents",
        "args_template": {
          "search_terms": "standards pour zones à faibles émissions (ZFE), véhicules, restrictions de circulation et pollution de l'air ; low emission zone standards for vehicle restrictions and air pollution",
          "limit": 8,
          "return_full_document": true
        },
    ...
    "tools_to_call": [
      {
        ...
        "tool": "retrieve_documents",
        "args_template": {
          "search_terms": "standards pour modéliser personne, adresse et preuve d'identité (nom, prénom, identifiant, naissance, rue, code postal, ville, justificatif) ; standards for modelling person, address and identity evidence (name, given name, identifier, birth, street, postal code, city, proof)",
          "limit": 10,
          "return_full_document": true
        },
    ...
    "tools_to_call": [
      {
        ...
        "tool": "retrieve_documents",
        "args_template": {
          "search_terms": "standards décrivant le concept de point de contact (email, téléphone, informations de contact) ; standards defining a contact point concept (email, phone, contact information)",
          "limit": 8,
          "return_full_document": true
        },
    ...
    "tools_to_call": [
      {
        ...
        "tool": "retrieve_documents",
        "args_template": {
          "search_terms": "standards pour tournées de collecte de déchets et identifiants de routes logistiques ; standards for waste collection routes and logistics route identifiers",
          "limit": 8,
          "return_full_document": true
        },
